...
**How to apply:** Use the same normalization for customer CRUD and quote creation, preserve null-email behavior, and never rewrite historical quote snapshots when a customer record changes.