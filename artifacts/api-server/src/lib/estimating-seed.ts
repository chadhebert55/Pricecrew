...
const requiredAdditionSubpanelItems = [
  {
    ...
    manufacturer: "Wic.",
    manufacturerPartNumber: "WIC. ROMEX 10/2",
    supplierSku: "5096",
    upc: "98010026310",
  ...
  },
  {
    ...
    supplier: "Northeast Electrical",
    manufacturer: "Wic.",
    manufacturerPartNumber: "WIC. ROMEX 10/3",
    supplierSku: "301392",
    upc: "98010026379",
    sourceDate: "2026-08-25",
    isDefault: false,
  },
  {
    ...
    unit: "ft",
    unitCost: 0,
    supplier: "Unresolved — no exact verified source price",
    sourceDate: "2026-08-25",
    isDefault: false,
  },
  {
    ...
    supplier: "Northeast Electrical",
    manufacturer: "Wia.",
    manufacturerPartNumber: "WIA. SER 1-1-1-",
    supplierSku: "295809",
    upc: "980120S0024",
    sourceDate: "2026-08-25",
    isDefault: false,
...
export async function seedEstimatorData(
  ...
  let verifiedItems: SeedPriceBookItem[] = [
    ...
    ...[
      ...
      ["Conductor", "Wia #6-6-6-6 aluminum SER — SKU 295791", "ft", 1.2377, "Wia.", "WIA. SER 6-6-6-", "295791", undefined, "980120S0022"],
      ["Conductor", "Wia #4-4-4-6 aluminum SER — SKU 295811", "ft", 1.3864, "Wia.", "WIA. SER 4-4-4-", "295811", undefined, "980120S0023"],
      ["Conductor", "Wia #2-2-2-4 aluminum SER — SKU 300631", "ft", 1.8577, "Wia.", "WIA. SER 2-2-2-", "300631", undefined, "980120S0048"],
      ["Conductor", "Wia 2/0-2/0-2/0-1 aluminum SER — SKU 448611", "ft", 3.186944, "Wia.", "WIA. SER 2/0-2/", "448611", undefined, "98012058489"],
      ["Conductor", "Wia 250-250-250-3/0 aluminum SER — SKU 502696", "ft", 5.1007, "Wia.", "WIA. SER 250-25", "502696", undefined, "980120S3003"],
      ["Conductor", "Wia TRIUG Wesleyan 350-350 MCM-4/0 aluminum cable — SKU 448629", "ft", 5.678337, "Wia.", "WIA. TRIUG 350-", "448629", undefined, "980120S0187"],
      ["Conductor", "Wia alternate #1-1-1-3 aluminum SER — SKU 507461", "ft", 4.0824, "Wia.", "WIA. SER 1-1-1-", "507461", undefined, "980120S3004"],
    ...
    },
    {
      ...
      supplier: "Northeast Electrical",
      manufacturer: "Wic.",
      manufacturerPartNumber: "WIC. ROMEX 6/2",
      supplierSku: "20262",
      sourceDate,
      isDefault: false,
    },
    ...
    ...(["60A", "100A"] as const).map((feederRating) => ({
      category: "Panel",
    ...
    ...([
      ...
      ["Square D", 100, 126.035, "SQD HOM2100", "94557"],
    ] as const).map(
      ([manufacturer, amperage, unitCost, manufacturerPartNumber, supplierSku]) => ({
        category: "Protection",
        item: `${manufacturer} ${amperage}A 2-pole Standard breaker`,
        unit: "ea",
        unitCost,
        supplier: "Northeast Electrical",
        manufacturer,
