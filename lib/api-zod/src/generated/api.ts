...
export const CreateQuoteBody = zod.object({
  ...
  "breakerAmperage": zod.union([zod.literal(15),zod.literal(20),zod.literal(30),zod.literal(40),zod.literal(50),zod.literal(60)]),
  "breakerPoleCount": zod.union([zod.literal(1),zod.literal(2)]),
  ...
  "feederConductor": zod.string().optional(),
  ...
  "breakerPoleCount": zod.number().min(1),
  "breakerProtectionType": zod.enum(['Standard', 'GFCI', 'AFCI', 'Dual Function']),
  "feederConductor": zod.enum(['4/0 aluminum SER', '2/0 copper SER', 'Reuse existing cable', '1/0 aluminum XHHW conductor', '3/0 aluminum XHHW conductor', '4/0 aluminum XHHW conductor', '1/0 copper service conductor alternative', '2/0 copper service conductor alternative', 'Other configured feeder conductor']),
  "includeFeederRaceway": zod.boolean().optional().describe('Optional job-specific raceway. When omitted, legacy individual-conductor quotes retain raceway; SER and reuse do not add it automatically.'),
  ...
  "branchCircuitAmperage": zod.union([zod.literal(15),zod.literal(20),zod.literal(30),zod.literal(40),zod.literal(50),zod.literal(60)]),
  "branchCircuitPoleCount": zod.union([zod.literal(1),zod.literal(2)]),
  "branchCircuitProtectionType": zod.enum(['Standard', 'GFCI', 'AFCI', 'Dual Function']),
  "branchCircuitCableType": zod.enum(['12/2 NM-B', '14/2 NM-B', '14/3 NM-B', '10/2 NM-B', '10/3 NM-B', '8/2 NM-B', '8/3 NM-B', '6/3 NM-B']),
  "equipmentCircuitFootage": zod.number().min(createQuoteBodyJobInputsOneoneEquipmentCircuitFootageMin),
  "equipmentCircuitAmperage": zod.union([zod.literal(20),zod.literal(30),zod.literal(40),zod.literal(50),zod.literal(60)]),
  "equipmentCircuitPoleCount": zod.literal(2),
  "equipmentCircuitProtectionType": zod.enum(['Standard', 'GFCI', 'AFCI', 'Dual Function']),
  "equipmentCircuitCableType": zod.enum(['12/2 NM-B', '10/2 NM-B', '10/3 NM-B', '8/2 NM-B', '8/3 NM-B', '6/3 NM-B']),
